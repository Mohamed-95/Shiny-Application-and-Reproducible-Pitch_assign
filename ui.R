...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            helpText(a("Help / Documentation", href="https://github.com/Mohamed-95/Shiny-Application-and-Reproducible-Pitch_assign/blob/main/README.md#shiny-application-and-reproducible-pitch_assign", target="_blank"))
        ),
        mainPanel(
